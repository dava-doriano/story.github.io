...
<!-- //header -->
<!-- navigation -->
	<div class="navigation-agileits" style="background-color: lightblue;">
		<div class="container">
...
<!-- <div class="footer"> -->
	...
	<!-- </div>	 -->
	<div class="footer-botm" style="width: 100%; padding: 20px;">
			<div class="container" >
				<div class="payment-w3ls">	
					<!-- <img src="images/card.png" alt=" " class="img-responsive"> -->
					<p class="text-center">Copyright &copy; Kelompok 3</p>
				</div>
